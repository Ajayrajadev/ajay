        ...
        {/* image start */}
          ...
          <div>
            <p className="text-white mt-4 summary aboutme">
              Hello! This is Ajay,  passionate front end web developer eager to
              make my mark in the world of web development. With a strong
              foundation in HTML, CSS and Bootstrap along with familiarity
              with JavaScript I'm excited to bring my skills to the
